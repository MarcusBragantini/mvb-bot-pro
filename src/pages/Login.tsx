        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-300">
              Sistema de Trading Inteligente com Estratégia Zeus
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-100">Estratégia Zeus</h3>
                <p className="text-gray-400">IA avançada com análise técnica de múltiplos indicadores</p>
              </div>
            </div>
